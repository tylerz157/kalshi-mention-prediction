...
INPUT_TRAIN  = Path('data/keyword_train.jsonl')
INPUT_VAL    = Path('data/keyword_val.jsonl')
OUTPUT_TRAIN = Path('data/keyword_enriched_train.jsonl')
OUTPUT_VAL   = Path('data/keyword_enriched_val.jsonl')
